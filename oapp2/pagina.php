...
<div class="fb-like" data-href="https://www.facebook.com/pages/OAPP/716336118389517?fref=ts" data-layout="box_count" data-action="like" data-show-faces="true" data-share="true"></div>
		...
		<nav>
			<ul data-collapse="accordion persist">
	...
	<?php 
		...
		require_once 'funciones/paginas_rand.php';
		 ...
		 while ($fila = mysql_fetch_array($resultado)) {
				 	echo '<div class="paginas_rand2_id">';
				 		
				 			echo '<h1 class="titulo_rand_id">'.utf8_encode($fila["nombre"]).'</h1><br>';
				 			echo '<p class="des_rand_id">'.utf8_encode($fila["descripcion"]).'</p><br>';
	 ...
	 <div class="container3">
		<footer class="footer">(c) Todos los derechos reservados por OAPP 2014-2015</footer>
	</div>
<script>
