...
<div id="barra1p"><h2 class="pp"><i class=" icon-bullhorn"></i> Publica Un Anuncio.</h2></div>
<hr>
...
<div id="barra2p"><h2 class="pp"><i class="icon-user"></i> Informacion del Vendedor</h2></div><br><br>
...
<div class="contienemodos">
<div class="modosletras">
  <h4 id="mdoletra">Elige  Que Metodo Deseas Utilizar.</h4>
</div>
<div class="modos">
  <a  href='publicaranor.php'><button class="modonormal">Normal</button></a>
  <p class="modo1des">*- El Modo Normal Anuncios Gratis y Sin Limites, Podras Publicar Tantos Anuncios Lo Desees.</p>
  <a  href='piblicarapre.php'><button class="modopremium">Premium</button></a>
  <p class="modo2des">*- El Modo Premium son Anuncios Fijos Por Toda OAPP,  Publica Anuncios Adecuado A tu Plan.</p>
