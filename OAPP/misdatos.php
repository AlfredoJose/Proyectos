...
<body>
	<header>
		...
		<a href=""><h1 class="titulares">Bienvenido </h1></a>
		<div style="clear: bont;"></div>
		<a href="top.php"><h1 id="top">Mis datos.</h1></a>
		<nav>
			<ul>
	...
	<div id="misdatos">
	<form id="fmrdatos" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
		<label>Usuario: <?php echo $usuario;?></label><br>
		<label>Contraseña: <?php echo $tel;?></label>
